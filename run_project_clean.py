...
def main():
    ...
    if successful_steps == len(pipeline_steps):
        ...
        print("   - reports/ - Analysis reports and insights")
        ...
        print("   2. Review reports/final_report.md for business insights")
        print("   3. Run SQL queries against your data warehouse")
